...
-- change to my screen shot app and lockscreen
...
default_apps.software_updater = "wezterm --title 'System Upgrade' -e sudo pacman -Syu"
--
default_apps.bluetooth_manager = "kitty -e bluetoothctl"
-- default_apps.network_manager = "kitty -e nmtui"
default_apps.network_manager = "wezterm -e nmtui"
